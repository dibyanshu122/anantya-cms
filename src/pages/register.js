      ...
      <div className="login-page">
        ...
        <div className="login-card">
          <div className="login-logo-wrap">
            ...
            <p className="login-subtitle">Register to manage your content</p>
          </div>
          ...
          <div className="login-footer">
            <div style={{ marginBottom: '10px' }}>
              Already have an account? <a href="/login" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 'bold' }}>Login Here</a>
            </div>
